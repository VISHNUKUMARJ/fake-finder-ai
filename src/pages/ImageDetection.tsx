        ...
        if (prev >= 100) {
          ...
          setResult({
            ...
            detailsText: isManipulated
              ? "Our AI has detected signs of manipulation in this image. The analysis indicates potential alterations in key areas."
              : "Our analysis indicates this image shows no signs of AI manipulation. The image appears to be authentic.",
          });
            ...
            {result && (
              <div className="mt-6">
                <Alert className="bg-blue-50 dark:bg-blue-950/50 border-blue-200 dark:border-blue-800">
                  ...
                  <AlertDescription>
                    Our AI analyzes multiple factors including pixel irregularities, 
                    metadata, and known manipulation patterns. Results are provided as 
                    probabilities and should be interpreted with appropriate context.
                  </AlertDescription>
                </Alert>
              </div>
            )}
